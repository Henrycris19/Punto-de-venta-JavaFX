...
public class RegistroController implements Initializable, ControlledScreen {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbAddsex.setItems(options);// estaba Options en lugar de options
    ...
    private void registroUsuario(ActionEvent event){
        ...
        try {
            conexion = DBConnection.connect();  // en la sentencia insert en lugar de especificar la tabla correo estaba la tabla email adem[as se escribi[o usuario en lugar de usuarios
            ...
            if (n > 0) {
                JOptionPane.showMessageDialog(null, "Registro exitoso"); //Estaba escrito Faregistro fallido en lugar de registro exitoso
            } 
